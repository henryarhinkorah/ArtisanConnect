    ...
    <NavigationContainer>
      ...
      <View style={styles.container}>
       ...
       <Stack.Navigator initialRouteName="Home">
          ...
          <Stack.Screen name="ArtisanType" component={ArtisanTypeOptionsScreen} options={{ headerShown: false }} />
...
function BottomNavigation() {
  ...
  return (
    <View style={styles.NavigationSection}>
      ...
      <NavigationItem icon="star-outline" text="Favorites" marginLeftValue={20} iconDirectory="Ionicons" onPress={() => navigation.navigate('')}  />
      <NavigationItem icon="add-circle-outline" text="Add post" marginLeftValue={20} iconDirectory="Ionicons" />
      <NavigationItem icon="message-outline" text="Messages" marginLeftValue={20} iconDirectory="MaterialCommunityIcons" />
